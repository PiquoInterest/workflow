...
fn parse_workflow_name_is_re_exported_from_the_crate_root() {
    let result = parse_workflow_name("workflow//./src/workflows/pulse//pulseRemoteWorkflow")
...
fn parse_class_name_is_re_exported_from_the_crate_root() {
    let result =
        parse_class_name("class//./src/models/point//Point").expect("valid class name must parse");
